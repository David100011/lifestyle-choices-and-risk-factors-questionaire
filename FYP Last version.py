...
while True :
    ...
    if LogIn_SignUp == "2":
        ...
        while accepted_terms_and_conditions == False:
            print ("Due to the personal nature of these questions and the need to perform more research we need consent in order to proceed. Do you accept the terms and conditions")
...
#
        if accepted_terms_and_conditions == True :
            ...
            p_dob = input ("Enter Date of Birth (dd/mm/yyyy):")
            ...
            while True:
                ...
                if p_living_location == "1":
                    ...
                    print ("Please selct one of the options provided.")
...
#
        ...
        print("Sex: " + p_sex)
        print("DOB: " + p_dob)
        print("Living Location: " + p_living_location)
            ...
            if Do_you_consume_sugar == "1" :
                  ...
                  if Do_you_consume_sugary_snacks == "1":
                      ...
                      if How_often_do_you_consume_them == "1":
                          ...
                          p_heart_score = p_heart_score - 3
            print (" ")           
            print ("Do you consume fast food.")
            Do_you_consume_fastfood = input ("1) No/ 2) Yes ")
            if Do_you_consume_fastfood == "1":
                pass
            elif Do_you_consume_fastfood == "2":
                print (" ")
                print ("How often do you consume it?") 
                How_often_do_you_consume_it = input ("1) Less then a once a week / 2) More than once a week / 3) Daily ")
                if How_often_do_you_consume_it == "1":
                    p_diabetes_score = p_diabetes_score - 1
                    p_heart_score = p_heart_score - 1
                elif How_often_do_you_consume_it == "2":
                    p_diabetes_score = p_diabetes_score - 2
                    p_heart_score = p_heart_score - 2
                elif How_often_do_you_consume_it == "3": 
                    p_diabetes_score = p_diabetes_score - 3
                    p_heart_score = p_heart_score - 3
                        
                        
                        
        print ("This will gauge your fitness level.") 
        print (" ")               
        print ("Do you exercise?")
        Do_you_exercise = input (" 1) No / 2) Yes ")
        if Do_you_exercise == "1" :
             print ("Recommend minimun 30 mins exercise per day.")
             p_lung_score = p_lung_score -1
             p_heart_score = p_heart_score - 1
        elif Do_you_exercise == "2" :
            p_lung_score = p_lung_score +1
            p_heart_score = p_heart_score + 1           
            print (" ") 
            print ("Which of the following exercise do you perform.")
            exercise_type = input ("1) Walking, 2) Jogging 3) Running")
            if exercise_type == "1":
                p_lung_score = p_lung_score +1
                p_heart_score = p_heart_score + 1
            ...
            How_often_do_you_exercise = input (" 1)Once a week / 2)More than once a week / 3) Daily ")
            if How_often_do_you_exercise == "1":
                p_lung_score = p_lung_score +1
                p_heart_score = p_heart_score + 1
            elif How_often_do_you_exercise == "2":
                p_lung_score = p_lung_score +2
                p_heart_score = p_heart_score + 2
            elif How_often_do_you_exercise == "3":
                p_lung_score = p_lung_score +3
                p_heart_score = p_heart_score + 3
